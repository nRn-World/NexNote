...
const AnimatedCanvasBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    let grid: { shapes: any[]; width: number; height: number } | null = null;
    let rafId: number;
